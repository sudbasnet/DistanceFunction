...
poi_india_postal <- read.csv("./shapefiles/india_poi/poi_india_postal.csv", header = T)
poi_india_university <- read.csv("./shapefiles/india_poi/poi_india_university.csv", header = T)
poi_india_college <- read.csv("./shapefiles/india_poi/poi_india_college.csv", header = T)
poi_india_school <- read.csv("./shapefiles/india_poi/poi_india_school.csv", header = T)
poi_india_hospital <- read.csv("./shapefiles/india_poi/poi_india_hospital.csv", header = T)
...
#------------------------------------------
getInfrastructureDistance <- function(x, poi, neighborhood_m = 10000.00){
    n <- nrow(x)
    m <- nrow(poi)
    ...
    for(i in 1:n){
        ...
        for(j in 1:m){
            ...
            if (d <= neighborhood_m){count <- count+1}
...
m_postal_distance <- getInfrastructureDistance(x = latlon_event_india_2014, poi = poi_india_postal, neighborhood_m = 10000.00)
m_hospital_distance <- getInfrastructureDistance(x = latlon_event_india_2014, poi = poi_india_hospital, neighborhood_m = 10000.00)
m_university_distance <- getInfrastructureDistance(x = latlon_event_india_2014, poi = poi_india_university, neighborhood_m = 10000.00)
m_college_distance <- getInfrastructureDistance(x = latlon_event_india_2014, poi = poi_india_college, neighborhood_m = 10000.00)
m_school_distance <- getInfrastructureDistance(x = latlon_event_india_2014, poi = poi_india_school, neighborhood_m = 10000.00)
#-------------------------------------------
...
# # save the data before, if necessary

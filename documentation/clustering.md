# Preliminary Clustering Analysis for Northeastern states of India

## 1 Experiments with spatiotemporal clustering
...
![Number of events in each cluster (noise not included), SPATIOTEMPORAL](./plots/Picture1.png)
...
![alt text](./plots/Rplot02_spatiotemporal_noise_max10.png "Cluster 0 (Noise)")
![alt text](./plots/Rplot02_spatiotemporal_cluster14_max10.png  "Cluster 14")
![alt text](./plots/Rplot02_spatiotemporal_cluster51_max10.png "Cluster 51")
![alt text](./plots/Rplot02_spatiotemporal_cluster9_max10.png "Cluster 9")
![alt text](./plots/Rplot02_spatiotemporal_cluster61_max10.png "Cluster 61")
![alt text](./plots/Rplot02_spatiotemporal_cluster63_max10.png "Cluster 63")
![alt text](./plots/Rplot02_spatiotemporal_cluster69_max10.png "Cluster 69")

### 1.2 Socioeconomic distances
...
![Number of events in each cluster (noise not included), SPATIOTEMPORAL](./plots/socioeconomic_clustering_structure.png)
...
![alt text](./plots/Rplot02_socioeconomic_noise_max10.png "Cluster 0 (Noise)")
![alt text](./plots/Rplot02_socioeconomic_cluster1_max10.png "Cluster 1")
![alt text](./plots/Rplot02_socioeconomic_cluster2_max10.png "Cluster 2")
![alt text](./plots/Rplot02_socioeconomic_cluster3_max10.png "Cluster 3")
![alt text](./plots/Rplot02_socioeconomic_cluster4_max10.png "Cluster 4")
![alt text](./plots/Rplot02_socioeconomic_cluster5_max10.png "Cluster 5")

### 1.3 Combined spatiotemporal and socioeconomic distances
...
![Number of events in each cluster (noise not included), SPATIOTEMPORAL](./plots/spatiotemporal_socioeconomic_cluslterStructure.png)
...
![alt text](./plots/Rplot02_combined_noise_max10.png "Cluster 0 (Noise)")
![alt text](./plots/Rplot02_combined_cluster10_max10.png "Cluster 10")
![alt text](./plots/Rplot02_combined_Cluster8_max10.png.png "Cluster 8")
![alt text](./plots/Rplot02_combined_Cluster4_max10.png "Cluster 4")
![alt text](./plots/Rplot02_combined_Cluster83_max10.png "Cluster 83")
![alt text](./plots/Rplot02_combined_Cluster85_max10.png "Cluster 85")
![alt text](./plots/Rplot02_combined_Cluster86_max10.png "Cluster 86")

## 2 Clustering Goodness
...
#### 2.2.1 Distance of centroid to points in other clusters
...
#### 2.2.2 Distance of centroid to centroid
...
#### 2.2.3 Distance between each pair of points in separate clusters
...
#### 2.2.4 Maximum distance between each pair of clusters
...
The scripts used in the above analysis can be found [HERE](./scripts/analysis/).